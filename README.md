...
It is a case study using SQL queries (JOIN, GROUP BY, Esist, OLAP) to analyze an online movie rental company with a database of customer information, movie ratings, background information on actors, and more.
## 🔍 Dataset
- Movie
